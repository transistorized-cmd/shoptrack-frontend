...
describe('AuthService', () => {
  ...
  describe('Authentication Methods', () => {
    describe('login', () => {
      ...
      it('should handle minimal login request', async () => {
        ...
        expect(mockApi.post).toHaveBeenCalledWith('/auth/login', minimalRequest);
        expect(result).toEqual(mockAuthResponse);
      });
    });
    ...
    describe('register', () => {
      ...
      it('should register successfully with valid data', async () => {
        ...
        expect(mockApi.post).toHaveBeenCalledWith('/auth/register', registerRequest);
        expect(result).toEqual(mockAuthResponse);
      });
      ...
      it('should handle minimal registration request', async () => {
        ...
        expect(mockApi.post).toHaveBeenCalledWith('/auth/register', minimalRequest);
        expect(result).toEqual(mockAuthResponse);
      });
    });
    ...
    describe('OAuth Authentication', () => {
      ...
      it('should login with OAuth successfully', async () => {
        ...
        expect(mockApi.post).toHaveBeenCalledWith('/auth/oauth/google', oauthRequest);
        expect(result).toEqual(mockAuthResponse);
      });

      it('should handle different OAuth providers', async () => {
        const providers: Array<'google' | 'apple' | 'microsoft'> = ['google', 'apple', 'microsoft'];
        ...
        for (const provider of providers) {
          ...
          expect(mockApi.post).toHaveBeenCalledWith(`/auth/oauth/${provider}`, request);
        }
      });
    ...
    describe('logout', () => {
      ...
      it('should handle logout API failure gracefully', async () => {
        ...
        expect(console.warn).toHaveBeenCalledWith('Logout API call failed:', apiError);
      });
  ...
  describe('Password Recovery', () => {
    describe('forgotPassword', () => {
      ...
      it('should send forgot password request successfully', async () => {
        ...
        expect(mockApi.post).toHaveBeenCalledWith('/auth/forgot-password', forgotPasswordRequest);
      ...
      it('should handle forgot password without recaptcha', async () => {
        ...
        expect(mockApi.post).toHaveBeenCalledWith('/auth/forgot-password', minimalRequest);
        expect(result).toEqual(mockAuthResponse);
      });
    });
    ...
    describe('resetPassword', () => {
      ...
      it('should reset password successfully', async () => {
        ...
        expect(mockApi.post).toHaveBeenCalledWith('/auth/reset-password', resetPasswordRequest);
        expect(result).toEqual(mockAuthResponse);
      });
    ...
    describe('changePassword', () => {
      ...
      it('should change password successfully', async () => {
        ...
        expect(mockApi.post).toHaveBeenCalledWith('/auth/change-password', changePasswordRequest);
        expect(result).toEqual(mockAuthResponse);
      });
  ...
  describe('Profile Management', () => {
    describe('getCurrentUser', () => {
      ...
      it('should handle API errors gracefully', async () => {
        mockApiWithoutAutoLogout.get.mockRejectedValue(new Error('Network error'));
    ...
    describe('updateProfile', () => {
      ...
      it('should update profile successfully', async () => {
        const updatedAuthResponse: AuthResponse = {
          success: true,
          user: { ...mockUser, firstName: 'UpdatedFirst', lastName: 'UpdatedLast' },
        ...
        expect(mockApi.put).toHaveBeenCalledWith('/auth/profile', updateProfileRequest);
      ...
      it('should handle partial profile updates', async () => {
        ...
        expect(mockApi.put).toHaveBeenCalledWith('/auth/profile', { firstName: 'NewFirstName' });
        expect(result).toEqual(mockAuthResponse);
      });
      ...
      it('should handle profile picture upload rejection', async () => {
        const requestWithPicture: UpdateProfileRequest = {
          firstName: 'Test',
          profilePicture: new File(['test'], 'test.jpg', { type: 'image/jpeg' })
        };

        await expect(authService.updateProfile(requestWithPicture))
  ...
  describe('Passkey / WebAuthn Support', () => {
    describe('getPasskeyCreationOptions', () => {
      ...
      it('should handle creation options failure', async () => {
        ...
        await expect(authService.getPasskeyCreationOptions()).rejects.toThrow('Passkey not supported');
      });
    });
    ...
    describe('registerPasskey', () => {
      ...
      it('should register passkey successfully', async () => {
        ...
        const result = await authService.registerPasskey(passkeyRegistrationRequest);

        expect(mockApi.post).toHaveBeenCalledWith('/passkey/register', passkeyRegistrationRequest);
        expect(result).toEqual(mockAuthResponse);
      });
    ...
    describe('loginWithPasskey', () => {
      ...
      it('should login with passkey successfully', async () => {
        ...
        expect(mockApi.post).toHaveBeenCalledWith('/passkey/verify', passkeyLoginRequest);
        expect(result).toEqual(mockAuthResponse);
      });
  ...
  describe('Two-Factor Authentication', () => {
    describe('enableTwoFactor', () => {
      const mockTwoFactorSetup: TwoFactorSetupResponse = {
        ...
        qrCodeUri: 'otpauth://totp/ShopTrack:test@example.com?secret=JBSWY3DPEHPK3PXP&issuer=ShopTrack',
      ...
      it('should handle two-factor setup failure', async () => {
        ...
        await expect(authService.enableTwoFactor()).rejects.toThrow('2FA setup failed');
      });
    });
    ...
    describe('verifyTwoFactor', () => {
      ...
      it('should verify two-factor code successfully', async () => {
        ...
        expect(mockApi.post).toHaveBeenCalledWith('/auth/2fa/verify', twoFactorRequest);
        expect(result).toEqual(mockAuthResponse);
      });

      it('should handle different 2FA providers', async () => {
        const providers: Array<'authenticator' | 'sms' | 'email'> = ['authenticator', 'sms', 'email'];
        ...
        for (const provider of providers) {
          ...
          expect(mockApi.post).toHaveBeenCalledWith('/auth/2fa/verify', request);
        }
      });
  ...
  describe('Session Management', () => {
    ...
    describe('revokeSession', () => {
      it('should revoke session successfully', async () => {
        ...
        expect(mockApi.delete).toHaveBeenCalledWith('/auth/sessions/session-123');
        expect(result).toEqual(mockAuthResponse);
      });
  ...
  describe('OAuth Account Management', () => {
    describe('connectOAuthAccount', () => {
      it('should get OAuth connection URL successfully', async () => {
        const authUrl = 'https://accounts.google.com/oauth/authorize?client_id=...';
      ...
      it('should handle different OAuth providers', async () => {
        ...
        for (const provider of providers) {
          ...
          expect(mockApi.get).toHaveBeenCalledWith(`/auth/oauth/${provider}/connect`);
          expect(result).toBe(authUrl);
        }
      });
    });
    ...
    describe('disconnectOAuthAccount', () => {
      it('should disconnect OAuth account successfully', async () => {
        ...
        expect(mockApi.delete).toHaveBeenCalledWith('/auth/oauth/google/disconnect');
        expect(result).toEqual(response);
      });
  ...
  describe('Email Confirmation', () => {
    describe('confirmEmail', () => {
      it('should confirm email with token successfully', async () => {
        ...
        expect(mockApi.get).toHaveBeenCalledWith('/auth/verify-email?token=confirm-token');
        expect(result).toEqual(mockAuthResponse);
      });
      ...
      it('should confirm email with token and email', async () => {
        ...
        const result = await authService.confirmEmail('confirm-token', 'test@example.com');

        expect(mockApi.get).toHaveBeenCalledWith('/auth/verify-email?token=confirm-token&email=test%40example.com');
        expect(result).toEqual(mockAuthResponse);
      });
    ...
    describe('resendEmailConfirmation', () => {
      it('should resend email confirmation successfully', async () => {
        ...
        expect(mockApi.post).toHaveBeenCalledWith('/auth/resend-email-confirmation');
        expect(result).toEqual(response);
      });
  ...
  describe('Error Handling and Edge Cases', () => {
    ...
    it('should handle malformed responses', async () => {
      ...
      const result = await authService.login({ email: 'test@example.com', password: 'test' });
