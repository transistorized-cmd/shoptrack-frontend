...
describe('receipts service (refactored with factories)', () => {
  ...
  describe('getReceipts', () => {
    it('should fetch receipts successfully', async () => {
      ...
      mockApi.get.mockResolvedValue(
        axiosResponseVariants.ok(mockPagedResult)
      );
    ...
    it('should handle API error', async () => {
      ...
      await expect(receiptsService.getReceipts(query))
        .rejects.toThrow();
    ...
    it('should include search parameters', async () => {
      ...
      mockApi.get.mockResolvedValue(
        axiosResponseVariants.ok(mockResults)
      );
  ...
  describe('getReceipt', () => {
    it('should fetch single receipt successfully', async () => {
      ...
      mockApi.get.mockResolvedValue(
        axiosResponseVariants.ok(mockReceipt)
      );
    ...
    it('should handle receipt not found', async () => {
      ...
      await expect(receiptsService.getReceipt(999))
        .rejects.toThrow();
  ...
  describe('uploadReceipt', () => {
    it('should upload receipt successfully', async () => {
      ...
      mockApi.post.mockResolvedValue(
        axiosResponseVariants.created(mockResult)
      );
    ...
    it('should handle upload failure', async () => {
      ...
      await expect(receiptsService.uploadReceipt(file))
        .rejects.toThrow();
    });
    ...
    it('should upload with plugin detection', async () => {
      ...
      const file = new File(['test'], 'receipt.jpg', { type: 'image/jpeg' });
      const result = await receiptsService.uploadReceipt(file, 'claude-processor');
  ...
  describe('updateReceipt', () => {
    it('should update receipt successfully', async () => {
      ...
      mockApi.put.mockResolvedValue(
        axiosResponseVariants.ok(updatedReceipt)
      );
    ...
    it('should handle update validation error', async () => {
      ...
      await expect(receiptsService.updateReceipt(1, updates))
        .rejects.toThrow();
    });
  });
  ...
  describe('updateReceiptItem', () => {
    it('should update receipt item successfully', async () => {
      ...
      mockApi.put.mockResolvedValue(
        axiosResponseVariants.ok(updatedItem)
      );
    ...
    it('should handle manual item correction', async () => {
      ...
      manualItem.totalPrice = 12.50;

      mockApi.put.mockResolvedValue(
        axiosResponseVariants.ok(manualItem)
      );
  ...
  describe('deleteReceipt', () => {
    it('should delete receipt successfully', async () => {
      mockApi.delete.mockResolvedValue(
        axiosResponseVariants.noContent()
      );
    ...
    it('should handle delete failure', async () => {
      ...
      await expect(receiptsService.deleteReceipt(1))
        .rejects.toThrow();
    });
  });
  ...
  describe('searchReceipts', () => {
    it('should search receipts by term', async () => {
      ...
      mockApi.get.mockResolvedValue(
        axiosResponseVariants.ok(searchResults)
      );
    ...
    it('should handle empty search results', async () => {
      ...
      mockApi.get.mockResolvedValue(
        axiosResponseVariants.ok(emptyResults)
      );
  ...
  describe('getReceiptStats', () => {
    it('should fetch receipt statistics', async () => {
      ...
      mockApi.get.mockResolvedValue(
        axiosResponseVariants.ok(mockStats)
      );
  ...
  describe('Error Handling', () => {
    it('should handle network errors gracefully', async () => {
      ...
      await expect(receiptsService.getReceipts({ page: 1, pageSize: 20 }))
  ...
  describe('Complex Scenarios', () => {
    it('should handle receipt with mixed confidence items', async () => {
      ...
      mockApi.get.mockResolvedValue(
        axiosResponseVariants.ok(receipt)
      );

      const result = await receiptsService.getReceipt(1);

      expect(result.items).toHaveLength(5);
      expect(result.items?.filter(item => item.confidence === 'high')).toHaveLength(2);
      expect(result.items?.filter(item => item.confidence === 'low')).toHaveLength(1);
      expect(result.items?.filter(item => item.confidence === 'manual')).toHaveLength(1);
    });
    ...
    it('should handle large receipt with many items', async () => {
      ...
      mockApi.get.mockResolvedValue(
        axiosResponseVariants.ok(largeReceipt)
      );
