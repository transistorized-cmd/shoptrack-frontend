...
describe("receipts service", () => {
  ...
  describe("getReceipts", () => {
    ...
    it("should propagate API errors", async () => {
      ...
      await expect(receiptsService.getReceipts()).rejects.toThrow(
        "Network error",
      );
    });
  });
  ...
  describe("createReceipt", () => {
    ...
    it("should propagate API errors", async () => {
      ...
      await expect(receiptsService.createReceipt({})).rejects.toThrow(
        "Validation failed",
      );
    });
  });
  ...
  describe("updateReceipt", () => {
    ...
    it("should propagate API errors", async () => {
      ...
      await expect(receiptsService.updateReceipt(1, {})).rejects.toThrow(
        "Update failed",
      );
    });
  });
  ...
  describe("getReceiptItems", () => {
    ...
    it("should propagate API errors", async () => {
      ...
      await expect(receiptsService.getReceiptItems(1)).rejects.toThrow(
        "Items not found",
      );
    });
  });
  ...
  describe("reprocessReceipt", () => {
    ...
    it("should propagate API errors", async () => {
      ...
      await expect(receiptsService.reprocessReceipt(1)).rejects.toThrow(
        "Reprocess failed",
      );
    });
  });
  ...
  describe("uploadReceipt", () => {
    ...
    it("should propagate API errors", async () => {
      ...
      await expect(receiptsService.uploadReceipt(mockFile)).rejects.toThrow(
        "Upload failed",
      );
    });
  });
  ...
  describe("validateFile", () => {
    ...
    it("should validate file with plugin key", async () => {
      ...
      const result = await receiptsService.validateFile(
        mockFile,
        "test-plugin",
      );
    ...
    it("should propagate API errors", async () => {
      ...
      await expect(receiptsService.validateFile(mockFile)).rejects.toThrow(
  ...
  describe("getStoreNames", () => {
    ...
    it("should propagate API errors", async () => {
      ...
      await expect(receiptsService.getStoreNames()).rejects.toThrow(
        "Service unavailable",
      );
    });
  });
  ...
  describe("getItemNames", () => {
    ...
    it("should propagate API errors", async () => {
      ...
      await expect(receiptsService.getItemNames()).rejects.toThrow(
        "Service unavailable",
      );
    });
  });
  ...
  describe("getCategories", () => {
    ...
    it("should propagate API errors", async () => {
      ...
      await expect(receiptsService.getCategories()).rejects.toThrow(
  ...
  describe("getUnits", () => {
    ...
    it("should propagate API errors", async () => {
      ...
      await expect(receiptsService.getUnits()).rejects.toThrow(
        "Units service unavailable",
      );
    });
  });
  ...
  describe("updateReceiptItem", () => {
    ...
    it("should propagate API errors", async () => {
      ...
      await expect(
        receiptsService.updateReceiptItem(1, mockItemUpdate),
