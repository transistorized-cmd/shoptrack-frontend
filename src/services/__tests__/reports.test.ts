...
describe('reportsService', () => {
  ...
  describe('generateReport', () => {
    ...
    it('should propagate API errors', async () => {
      ...
      // Act & Assert
      await expect(reportsService.generateReport(mockRequest)).rejects.toThrow('Report generation failed')
      expect(mockApi.post).toHaveBeenCalledTimes(1)
    })
    ...
    it('should handle network errors', async () => {
      ...
      // Act & Assert
      await expect(reportsService.generateReport(mockRequest)).rejects.toThrow('Network Error')
    })
  ...
  describe('exportReport', () => {
    ...
    it('should handle export errors', async () => {
      ...
      // Act & Assert
      await expect(reportsService.exportReport(mockRequest, 'pdf')).rejects.toThrow('Export failed')
      expect(mockApi.post).toHaveBeenCalledTimes(1)
    })
  ...
  describe('service integration', () => {
    it('should work with generateReport and exportReport in sequence', async () => {
      ...
      const exportedBlob = await reportsService.exportReport(mockRequest, 'pdf')
