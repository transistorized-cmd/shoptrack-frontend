...
describe("receipts store", () => {
  ...
  describe("computed properties", () => {
    ...
    it("should compute pendingReceipts correctly", () => {
      ...
      expect(
        store.pendingReceipts.every((r) => r.processingStatus === "pending"),
      ).toBe(true);
    });
  ...
  describe("fetchReceipts", () => {
    ...
    it("should handle fetch receipts error", async () => {
      ...
      mockReceiptsService.getReceipts.mockRejectedValue(
  ...
  describe("uploadReceipt", () => {
    ...
    it("should handle upload error and rethrow", async () => {
      ...
      mockReceiptsService.uploadReceipt.mockRejectedValue(
        new Error(errorMessage),
      );
  ...
  describe("deleteReceipt", () => {
    ...
    it("should handle delete error and rethrow", async () => {
      ...
      mockReceiptsService.deleteReceipt.mockRejectedValue(
        new Error(errorMessage),
      );
  ...
  describe("updateReceipt", () => {
    ...
    it("should update receipt successfully", async () => {
      ...
      expect(mockReceiptsService.updateReceipt).toHaveBeenCalledWith(
        1,
        updates,
      );
    });
    ...
    it("should handle update error and rethrow", async () => {
      ...
      mockReceiptsService.updateReceipt.mockRejectedValue(
        new Error(errorMessage),
      );
  ...
  describe("reprocessReceipt", () => {
    ...
    it("should reprocess receipt successfully", async () => {
      ...
      expect(mockReceiptsService.reprocessReceipt).toHaveBeenCalledWith(
        1,
        undefined,
      );
    });
    ...
    it("should handle reprocess error and rethrow", async () => {
      ...
      mockReceiptsService.reprocessReceipt.mockRejectedValue(
        new Error(errorMessage),
      );
  ...
  describe("concurrent operations", () => {
    ...
    it("should handle upload and fetch concurrently", async () => {
      ...
      await Promise.all([store.uploadReceipt(mockFile), store.fetchReceipts()]);
