...
describe('NotFound.vue', () => {
  ...
  describe('Basic Rendering', () => {
    it('renders 404 error message', () => {
      ...
      expect(wrapper.text()).toContain('The page you\'re looking for might have been removed')
    })
    ...
    it('renders support contact link', () => {
      ...
      const supportLink = wrapper.find('a[href="mailto:support@shoptrack.example.com"]')
  ...
  describe('Unauthorized Access Detection', () => {
    ...
    it('shows unauthorized message for protected resource paths when authenticated', () => {
      ...
      expect(unauthorizedMessage.text()).toContain("You don't have permission to access this resource")
    })
  ...
  describe('Accessibility', () => {
    ...
    it('provides descriptive text content', () => {
      ...
      expect(wrapper.text()).toContain("Oops! This page doesn't exist")
      expect(wrapper.text()).toContain('might have been removed, renamed, or is temporarily unavailable')
    })
