...
test.describe('Error Scenarios and Edge Cases Critical Paths', () => {
  ...
  test.describe('Network and Connectivity Errors', () => {
    test('should handle complete network failure gracefully', async ({ page }) => {
      ...
      await expectElementText(page, '[data-testid="offline-message"]', /no.*internet.*connection|offline/i);
      ...
      await expect(page.locator('[data-testid="upload-receipt"]')).toBeDisabled();
      ...
      await expect(page.locator('[data-testid="view-cached-receipts"]')).toBeEnabled();
      ...
      await expect(page.locator('[data-testid="upload-receipt"]')).toBeEnabled();
    ...
    test('should handle slow network conditions', async ({ page }) => {
      ...
      await expectElementVisible(page, '[data-testid="slow-connection-warning"]');
  ...
  test.describe('Server and API Errors', () => {
    test('should handle 500 internal server errors', async ({ page }) => {
      ...
      await expectElementText(page, '[data-testid="error-message"]', /server.*error|something.*went.*wrong/i);
      ...
      await expect(page.locator('[data-testid="server-error"]')).not.toBeVisible();
    });
    ...
    test('should handle 401 authentication errors', async ({ page }) => {
      ...
      await expectElementText(page, '[data-testid="auth-error-message"]', /session.*expired|please.*login/i);
    ...
    test('should handle 403 forbidden errors', async ({ page }) => {
      ...
      await expectElementText(page, '[data-testid="access-denied-message"]', /access.*denied|insufficient.*permissions/i);
    ...
    test('should handle 429 rate limiting errors', async ({ page }) => {
      ...
      await expectElementText(page, '[data-testid="rate-limit-message"]', /rate.*limit|too.*many.*requests/i);

      // Should show retry countdown
      await expectElementVisible(page, '[data-testid="retry-countdown"]');
      await expectElementText(page, '[data-testid="countdown-timer"]', /60.*seconds/i);
    ...
    test('should handle service maintenance mode', async ({ page }) => {
      ...
      await expectElementText(page, '[data-testid="maintenance-message"]', /maintenance|temporarily.*unavailable/i);
      ...
      await expectElementVisible(page, '[data-testid="offline-mode-activated"]');
      await expect(page.locator('[data-testid="view-cached-data"]')).toBeEnabled();
    });
  });
  ...
  test.describe('Data Validation and Input Errors', () => {
    test('should handle malformed API responses', async ({ page }) => {
      ...
      await expectElementText(page, '[data-testid="parsing-error-message"]', /data.*format.*error|parsing.*failed/i);
    ...
    test('should handle missing required fields in forms', async ({ page }) => {
      ...
      await expectElementText(page, '[data-testid="merchant-error"]', /merchant.*required/i);
      await expectElementText(page, '[data-testid="amount-error"]', /amount.*required/i);

      // Should highlight invalid fields
      await expect(page.locator('[data-testid="merchant-input"]')).toHaveClass(/error|invalid/);
      await expect(page.locator('[data-testid="amount-input"]')).toHaveClass(/error|invalid/);

      // Should focus first invalid field
      const focusedElement = page.locator(':focus');
      await expect(focusedElement).toBe(page.locator('[data-testid="merchant-input"]'));
    });
    ...
    test('should handle invalid file uploads', async ({ page }) => {
      ...
      await expectElementText(page, '[data-testid="file-type-message"]', /invalid.*file.*type|supported.*formats/i);
      ...
      await expectElementText(page, '[data-testid="file-size-message"]', /file.*too.*large|10MB.*limit/i);
      ...
      await expectElementText(page, '[data-testid="corruption-message"]', /corrupted|unable.*to.*process/i);
    });
    ...
    test('should handle invalid date ranges and inputs', async ({ page }) => {
      ...
      await expectElementText(page, '[data-testid="date-range-message"]', /end.*date.*before.*start|invalid.*range/i);
      ...
      await expectElementText(page, '[data-testid="future-date-message"]', /future.*date|cannot.*be.*later/i);
      ...
      await expectElementText(page, '[data-testid="large-range-message"]', /date.*range.*too.*large|performance.*impact/i);
    });
  });
  ...
  test.describe('Browser and Platform Compatibility Issues', () => {
    test('should handle localStorage/sessionStorage failures', async ({ page }) => {
      ...
      await expectElementText(page, '[data-testid="storage-message"]', /storage.*disabled|private.*browsing/i);
    ...
    test('should handle JavaScript errors gracefully', async ({ page }) => {
      ...
      if (jsErrors.length > 0) {
        ...
        await expectElementVisible(page, '[data-testid="error-recovery-button"]');
    ...
    test('should handle unsupported browser features', async ({ page }) => {
      ...
      await expectElementVisible(page, '[data-testid="browser-compatibility-warning"]');
      await expectElementText(page, '[data-testid="compatibility-message"]', /browser.*not.*supported|upgrade.*browser/i);

      // Should provide alternative upload methods
      await expectElementVisible(page, '[data-testid="alternative-upload-methods"]');
    ...
    test('should handle memory limitations', async ({ page }) => {
      ...
      await expectElementVisible(page, '[data-testid="memory-optimization-active"]');
      ...
      await expectElementVisible(page, '[data-testid="export-instead-of-render"]');
    });
  });
  ...
  test.describe('Data Corruption and Recovery', () => {
    test('should detect and handle corrupted local data', async ({ page }) => {
      ...
      await expectElementVisible(page, '[data-testid="data-corruption-detected"]');
      await expectElementText(page, '[data-testid="corruption-message"]', /data.*corrupted|reset.*settings/i);
    ...
    test('should handle partial data synchronization failures', async ({ page }) => {
      await receiptsPage.goto();
      ...
      await expectElementText(page, '[data-testid="sync-summary"]', /2.*successful.*2.*failed/i);

      // Should list failed items with reasons
      await expectElementVisible(page, '[data-testid="failed-items-list"]');
      await expectElementText(page, '[data-testid="failed-item-receipt-3"]', /validation.*error/i);
    ...
    test('should backup and restore critical data', async ({ page }) => {
      ...
      await expectElementVisible(page, '[data-testid="integrity-check-passed"]');
    });
  });
  ...
  test.describe('Security and Edge Case Scenarios', () => {
    test('should handle XSS attempts gracefully', async ({ page }) => {
      ...
      const merchantValue = await page.inputValue('[data-testid="merchant-input"]');
      expect(merchantValue).not.toContain('<script>');

      // Should show sanitized content
      await expectElementText(page, '[data-testid="merchant-display"]', /&lt;script&gt;/);
    });
    ...
    test('should handle malicious file uploads', async ({ page }) => {
      ...
      await expectElementText(page, '[data-testid="security-message"]', /malicious.*content|security.*violation/i);
    ...
    test('should handle CSRF protection', async ({ page }) => {
      ...
      await expectElementText(page, '[data-testid="csrf-message"]', /security.*token|refresh.*page/i);
