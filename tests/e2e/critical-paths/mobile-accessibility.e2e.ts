...
test.describe("Mobile and Accessibility Critical Paths", () => {
  test.describe("Mobile Viewport Testing", () => {
    test.describe("iPhone 12 Portrait", () => {
      ...
      test("should handle mobile authentication flow", async ({ page }) => {
        ...
        await expect(
          page.locator('[data-testid="mobile-login-form"]'),
        ).toBeVisible();
      ...
      test("should handle mobile receipt upload with touch gestures", async ({
        page,
      }) => {
        const authPage = new AuthPage(page);
        ...
        await expect(
          page.locator('[data-testid="mobile-upload-zone"]'),
        ).toBeVisible();
        await expect(
          page.locator('[data-testid="camera-upload-btn"]'),
        ).toBeVisible();
        await expect(
          page.locator('[data-testid="gallery-upload-btn"]'),
        ).toBeVisible();
        ...
        await expect(
          page.locator('[data-testid="mobile-upload-progress"]'),
        ).toBeVisible();
        await expect(
        ...
        await expect(
          page.locator('[data-testid="mobile-receipt-preview"]'),
        ).toBeVisible();
        await expectElementText(
          page,
          '[data-testid="preview-merchant"]',
          "Mobile Store",
        );
        await expectElementText(
          page,
      ...
      test("should handle mobile navigation and menu interactions", async ({
        page,
      }) => {
        const authPage = new AuthPage(page);
        ...
        await expect(
          page.locator('[data-testid="mobile-nav-receipts"]'),
        ).toBeVisible();
        await expect(
          page.locator('[data-testid="mobile-nav-reports"]'),
        ).toBeVisible();
        await expect(
          page.locator('[data-testid="mobile-nav-settings"]'),
        ).toBeVisible();
        ...
        await expect(
          page.locator('[data-testid="mobile-receipts-page"]'),
        ).toBeVisible();

        // Test mobile search functionality
        await page.tap('[data-testid="mobile-search-toggle"]');
        await expect(
          page.locator('[data-testid="mobile-search-input"]'),
        ).toBeVisible();
        ...
        const receiptCard = page
          .locator('[data-testid="receipt-card"]')
          .first();
        ...
        if (cardBox) {
          ...
          await expect(
            page.locator('[data-testid="mobile-swipe-actions"]'),
          ).toBeVisible();
          await expect(
            page.locator('[data-testid="mobile-edit-action"]'),
          ).toBeVisible();
          await expect(
            page.locator('[data-testid="mobile-delete-action"]'),
          ).toBeVisible();
        }
      });
    });
    ...
    test.describe("iPad Landscape", () => {
      ...
      test("should handle tablet layout and interactions", async ({ page }) => {
        ...
        await expect(
          page.locator('[data-testid="tablet-sidebar"]'),
        ).toBeVisible();
        await expect(
          page.locator('[data-testid="tablet-main-content"]'),
        ).toBeVisible();
        await expect(
          page.locator('[data-testid="tablet-charts-grid"]'),
        ).toBeVisible();
        ...
        await expect(
          page.locator('[data-testid="tablet-receipts-grid"]'),
        ).toBeVisible();
        ...
        await expect(
          page.locator('[data-testid="multi-select-toolbar"]'),
        ).toBeVisible();
      });
    });
    ...
    test.describe("Device Orientation", () => {
      ...
      test("should handle orientation changes gracefully", async ({
        ...
        test.skip(
          browserName === "webkit",
          "Orientation API not fully supported in webkit",
        );
        ...
        await expect(
          page.locator('[data-testid="landscape-navigation"]'),
        ).toBeVisible();
        ...
        await page.goto("/upload");
        await expect(
          page.locator('[data-testid="landscape-upload-zone"]'),
        ).toBeVisible();
  ...
  test.describe("Accessibility Testing", () => {
    test("should meet WCAG 2.1 AA compliance standards", async ({ page }) => {
      ...
      ).toHaveAttribute("aria-label", /login|sign in/i);
      ...
      if ((await contrastElement.count()) > 0) {
        const styles = await contrastElement.evaluate((el) =>
          getComputedStyle(el),
        );
    ...
    test("should support screen reader navigation", async ({ page }) => {
      ...
      for (let i = 0; i < imageCount; i++) {
        ...
        expect(
          altText !== null || ariaLabel !== null || role === "presentation",
        ).toBe(true);
      }
    });
    ...
    test("should provide proper error announcements", async ({ page }) => {
      ...
      const successRegion = page.locator(
  ...
  test.describe("Touch and Gesture Testing", () => {
    ...
    test("should handle touch gestures for receipt management", async ({
      page,
    }) => {
      const authPage = new AuthPage(page);
      ...
      if (cardBox) {
        ...
        await expect(
          page.locator('[data-testid="context-edit"]'),
        ).toBeVisible();
        await expect(
          page.locator('[data-testid="context-delete"]'),
        ).toBeVisible();
        await expect(
          page.locator('[data-testid="context-share"]'),
        ).toBeVisible();
      }
  ...
  test.describe("Performance on Mobile Devices", () => {
    ...
    test("should maintain performance standards on mobile", async ({
      page,
    }) => {
      const authPage = new AuthPage(page);
      ...
      console.log(
        `📱 Mobile Performance: Login ${loginTime}ms, Navigation ${navTime}ms, Scroll ${scrollTime}ms`,
      );
    });
